                ...
                <div class="p-1">
                    ...
                    <div>
                        <div class="mx-auto pull-right">
                            <div class="p-1">
                                <form action="{{ route('htt') }}" method="GET" role="search">
                
                                    <div class="input-group">
                                        {{-- reset --}}
                                        <a href="{{ route('htt') }}" class=" mr-5">
                                        ...
                                        <select name="llojisherbimi" class="custom-select">
                                            ...
                                            <option value="Verifikim dhe Bashkevulosje" {{ $llojisherbimi == 'Verifikim dhe Bashkevulosje' ? 'selected' : '' }} >Verifikim dhe Bashkevulosje</option>
                                            <option value="Verifikim(P) & BV" {{ $llojisherbimi == 'Verifikim(P) & BV' ? 'selected' : '' }} >Verifikim(P) & BV</option>
                                            <option value="Verifikim" {{ $llojisherbimi == 'Verifikim' ? 'selected' : '' }} >Verifikim</option>
                                        </select>
                        ...
                        <tbody>
                            ...
                            @foreach ($products as $product) 
                                <tr>
                                    ...
                                    <td>{{ $product->vula_e_mors_e_htt}}</td>
                                    <td>{{ $product->vula_e_mors_e_oshee}}</td>
                                    <td>{{ $product->personeli_htt}}</td>
                                    <td>{{ $product->personeli_i_oshee}}</td>
                                    <td>{{ $product->instrumentietalon}}</td>
                                    <td>{{ $product->analiza}}</td>
                                    <td>{{ $product->col_9_char}}</td>
                                    <td>{{ $product->col_16_char}}</td>
                                    <td>{{ $product->a1}}</td>
                                    <td>{{ $product->a2}}</td>
